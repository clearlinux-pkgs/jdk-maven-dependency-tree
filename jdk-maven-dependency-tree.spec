...
#
Name     : jdk-maven-dependency-tree
Version  : 3.0
Release  : 3
URL      : http://repo1.maven.org/maven2/org/apache/maven/shared/maven-dependency-tree/3.0/maven-dependency-tree-3.0-source-release.zip
Source0  : http://repo1.maven.org/maven2/org/apache/maven/shared/maven-dependency-tree/3.0/maven-dependency-tree-3.0-source-release.zip
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-maven-dependency-tree-data
...
%package data
Summary: data components for the jdk-maven-dependency-tree package.
Group: Data

%description data
data components for the jdk-maven-dependency-tree package.


%prep
%setup -q -n maven-dependency-tree-3.0

find -name Maven3DependencyGraphBuilder.java -delete
python3 /usr/share/java-utils/pom_editor.py pom_remove_dep org.sonatype.aether:
...
%install
xmvn-install  -R .xmvn-reactor -n maven-dependency-tree -d %{buildroot}
...
%files data
%defattr(-,root,root,-)
/usr/share/java/maven-dependency-tree/maven-dependency-tree.jar
/usr/share/maven-metadata/maven-dependency-tree.xml
/usr/share/maven-poms/maven-dependency-tree/maven-dependency-tree.pom
